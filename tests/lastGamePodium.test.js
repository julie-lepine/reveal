...
describe("lastGamePodium", () => {
  it("serializeLastGameStandings ne garde que les champs UI", () => {
    ...
    assert.deepEqual(out, [
      { name: "Ada", score: 30, rank: 1, emoji: "🦊", color: "#f00", nameColor: null, signature: false, avatarPath: null, avatarRev: 0 },
      { name: "Bob", score: 10, rank: 2, emoji: "🐱", color: "#0f0", nameColor: null, signature: false, avatarPath: null, avatarRev: 0 },
    ]);
  });
