...
export const SPEED_VOTE_THEMES = [
  ...
  },
  {
    ...
    questions: [
      ...
      "Qui serait le plus aimé par des inconnus en 5 minutes ?",
    ],
  },
  {
    id: "survival",
    ...
    questions: [
      ...
      "Qui serait celui qui ferme toujours les yeux au mauvais moment ?",
      "Qui deviendrait rapidement un boulet pour le groupe ?",
      "Qui survivrait seul le plus longtemps sans personne ?",
      ...
      "Qui survivrait le mieux uniquement avec du hasard ?",
      "Qui deviendrait un personnage secondaire dès le début ?",
      "Qui oublierait un objet vital dans une fuite ?",
      "Qui survivrait mais deviendrait complètement parano ?",
      "Qui sacrifierait le groupe pour sauver un snack ?",
  ...
  },
  {
    ...
    questions: [
      ...
      "Qui ferait le plus de choix catastrophiques par semaine ?",
      "Qui survivrait le moins bien à la vie adulte ?",
      "Qui serait le plus susceptible de se faire avoir par un scam ?",
      "Qui pourrait déclencher un conflit mondial par accident ?",
      "Qui ferait un achat qu’il regrette en moins de 10 secondes ?",
      "Qui serait banni d’un groupe WhatsApp en moins d’une semaine ?",
      "Qui ferait semblant de comprendre une situation complexe ?",
      "Qui pourrait transformer une situation simple en catastrophe ?",
      "Qui ferait rire les gens au pire moment possible ?",
      "Qui dirait “t’inquiète j’ai géré” alors que pas du tout ?",
      "Qui oublierait ce qu’il fait en plein milieu d’une action ?",
      "Qui serait capable de rater une porte ouverte ?",
      "Qui serait le protagoniste d’une série de malentendus ?",
    ],
  },
  {
    id: "party",
    ...
    questions: [
      ...
      "Qui disparaît toujours pour des raisons mystérieuses ?",
      ...
      "Qui devient DJ sans autorisation officielle ?",
      "Qui finit toujours par parler à tout le monde sauf ses amis ?",
    ],
  },
  {
    id: "awkward",
    ...
    questions: [
      ...
      "Qui fait semblant de ne pas avoir vu quelqu’un qu’il connaît ?",
      ...
      "Qui a déjà essayé d’être discret… et s’est encore plus fait remarquer ?",
  ...
  },
  {
    ...
    questions: [
      ...
      "Qui ferait semblant de ne pas connaître quelqu’un pour éviter un moment gênant ?",
      ...
      "Qui changerait de camp si ça l’arrange ?",
