...
export const TIER_LISTS = [
  ...
  },
  {
    ...
    emoji: "🦸",
    items: [
      "Toujours trouver un chargeur adapté",
      "Cuire des pâtes toujours al dente au feeling",
      "Deviner le plot twist trop tôt",
      "Place de parking parfaite",
      "Couper les gâteaux en parts égales",
      "Survivre sans café une journée entière",
      "Reconnaître tous les génériques possibles",
