  ...
  function render() {
    ...
    app.innerHTML = pageShell({
      ...
      content: `
        ...
        <p class="game-intro">Un chrono part de 0 et monte vers une cible (7 à 20 s). Il disparaît un peu avant la cible — un délai différent à chaque manche : tape à l'instinct, au plus proche. Le plus précis gagne.</p>
