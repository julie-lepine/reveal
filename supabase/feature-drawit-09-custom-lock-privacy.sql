-- =============================================================================
-- FEATURE-DRAWIT-09 — lock customs = lobbyStarted uniquement
-- Un runId stale (après complete / merge guest) ne doit plus verrouiller la prépa.
--
-- Ordre d'application : APRÈS feature-drawit-08-custom-words.sql
